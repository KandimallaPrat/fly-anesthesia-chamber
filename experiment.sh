...
# /usr/bin/python3 startup.py --datadir /media/pi/Elements/anesthesia-reanimation/data/ --t_experiment 120 --n_flies 4 2 3 2 0 0 --t_motor_on 60 65 70 75 80 --motor_duration 1 1 1 1 1 --t_led_on 60 --led_duration 20
