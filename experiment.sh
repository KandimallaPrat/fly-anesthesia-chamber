...
/usr/bin/python3 startup.py --datadir /media/pi/Elements/anesthesia-reanimation/data/ --t_experiment 180 --n_flies 2 --t_motor_on 20 40  --motor_duration 10 10
...
# /usr/bin/python3 startup.py --datadir /media/pi/Elements/anesthesia-reanimation/data/ --t_experiment 21600 --n_flies 30 --t_motor_on 3600 5400 7200 9000 12600 16200 19800  --motor_duration 5 5 5 5 10 10 10
